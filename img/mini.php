...
$query = mysql_query("SELECT imgname1, imgname2 FROM voting");
while ($row = mysql_fetch_array($query)) {
    resize_image('max', $row['imgname1'], 'mini/' . $row['imgname1'], 100, 100);
    resize_image('max', $row['imgname2'], 'mini/' . $row['imgname2'], 100, 100);
}
